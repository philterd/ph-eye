...
curl -s -X POST http://localhost:5000/find \
  ...
  -d'{"text": "George Washington was president and he lived in Virginia. He had high blood pressure and is looking for help.", "threshold": 0.50, "labels": ["Person", "Place"]}' | jq
